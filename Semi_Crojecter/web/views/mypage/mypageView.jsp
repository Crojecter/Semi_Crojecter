...
<form id="updateForm" action="<%=request.getContextPath()%>/mUpdate.do" method="post">
            ...
            <tr>
                ...
                value="<%= m.getMname()%>" readonly><br>
            </tr>
            <tr>
                <td><label class="inputContent">이메일</label></td>
                <td colspan="2"><input type="email" class="inputContent" value="<%= m.getMemail()%>" readonly></td><br>
            </tr>
            <tr>
                <td><label class="inputContent">호두</label></td>
                <td colspan="2"><input type="text" class="inputContent" value="<%= m.getMhodu()%>" readonly></td><br>
            </tr>
            <tr>
